	...
	<?php
		if($TEST1=='F')
		{
			for($i=0;$i<count($finalfemaleresult);$i+=2)
			{
				...
				echo"<input type='checkbox' checked></input>";
					echo"$selectcolor";
				echo"<font color='red' size='+2'>&#9792</font><a target=\"_blank\" href=driver/detail_table.php?neuron=".$finalfemaleresult[$i].">";
				...
				echo"<tr>";
        			echo"<td width='50%' bgcolor='#FFFFFF'><div align='center'>";
				echo"<a target=\"_blank\" href=\"driver/driverIMG/$finalfemaleresult[$i]/".$finalfemaleresult[$i]."_lsm.png\">";
		    		echo"<img src=\"driver/driverIMG/$finalfemaleresult[$i]/".$finalfemaleresult[$i]."_lsmResize.png\"></a>";
				echo"</div></td>";
				echo"<td width='50%' bgcolor='#FFFFFF'><div align='center'>";
		    		$i++;
        			if($i<count($finalfemaleresult))
		...
		if($TEST1=='M')
		{
			for($i=0;$i<count($finalmaleresult);$i+=2)
			{
				...
				echo"<input type='checkbox' checked></input>";
					echo"$selectcolor";
				echo"<font color='blue' size='+2'>&#9794</font><a target=\"_blank\" href='driver/detail_table.php?neuron=".$finalmaleresult[$i]."'>";
				...
				echo"<tr>";
        			echo"<td width='50%' bgcolor='#FFFFFF'><div align='center'>";
				echo"<a target=\"_blank\" href=\"driver/driverIMG/$finalmaleresult[$i]/".$finalmaleresult[$i]."_lsm.png\">";
		    		echo"<img src=\"driver/driverIMG/$finalmaleresult[$i]/".$finalmaleresult[$i]."_lsmResize.png\"></a>";
				echo"</div></td>";
				echo"<td width='50%' bgcolor='#FFFFFF'><div align='center'>";
        			$i++;
        			if($i<count($finalmaleresult))
